...
const CreateListing = () => {
    ...
    const handleRemovePhoto = (indexToRemove) => {
            ...
            setPhotos((prevPhotos) => prevPhotos.filter((__, index) => index !== indexToRemove));
    ...
    const handlePost =async(e)=>{
        ...
        try{
            ...
            //append photos to formData object
            photos.forEach((photo)=>{
                listingForm.append('listingPhotos',photo)
            })

            //send a post request to server
            const response = await fetch('https://hotelserver-9wlo.onrender.com/properties/create',{
                method:"POST",
                body:listingForm
            })
            ...
            <div className='create-listing'>
                ...
                <form onSubmit={handlePost}>
                    <div className='create-listing_step1 '>
                        ...
                        <h3>
                            Which of these categories best describes you place
                        </h3>
